                ...
                <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <c:if test="${! renderContext.editMode && jcr:hasPermission(renderContext.mainResource.node, 'jContentAccess')}">
                            <li>
                                <a href="<c:url value='${url.edit}'/>" class="dropdown-item text-success">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
                    ...
                    <li>
                        <a class="dropdown-item logout" href="${url.logout}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16" aria-hidden="true" focusable="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <c:if test="${error}">
                        ...
                        <label for="username-${currentNode.identifier}" class="visually-hidden">${usernameLabel}</label>
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="username-${currentNode.identifier}" name="username" placeholder="${fn:escapeXml(usernameLabel)}" <c:if test="${! empty username}"><c:out value=" "/>value="${fn:escapeXml(username)}"</c:if> required autofocus>
                        </div>
                        ...
                        <label for="password-${currentNode.identifier}" class="visually-hidden">${passwordLabel}</label>
                        <div class="input-group mb-3">
                            <span class="input-group-text" aria-hidden="true">
                            ...
                            <input type="password" class="form-control" id="password-${currentNode.identifier}" name="password" placeholder="${fn:escapeXml(passwordLabel)}" required>
                        </div>
