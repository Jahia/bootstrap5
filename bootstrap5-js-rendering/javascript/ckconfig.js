...
CKEDITOR.editorConfig = (config) => {
    ...
    config.templates_files = [`${contextPath}/modules/bootstrap5-js-rendering/javascript/cktemplates.js`];
...
function loadDependencies(callback) {
    ...
    loadScript(`${basePath}/modules/bootstrap5-js-rendering/javascript/beautify-html.min.js`, function () {
        loadScript(`${basePath}/modules/bootstrap5-js-rendering/javascript/purify.min.js`, function () {
            setTimeout(function () {
...
CKEDITOR.plugins.add('tidy', {
    ...
    init: function (editor) {
        editor.ui.addButton('Wash', {
            ...
            command: 'cleanHTML',
            toolbar: 'cleanup',
            icon: `${contextParams.contextPath}/modules/bootstrap5-js-rendering/img/wash.png`
        });
